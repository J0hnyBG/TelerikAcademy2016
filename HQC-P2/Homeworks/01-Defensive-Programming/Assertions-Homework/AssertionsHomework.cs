...
class AssertionsHomework
{
        ...
        where T : IComparable<T>
    {
        ...
        Debug.Assert(startIndex <= minElementIndex && minElementIndex <= endIndex, nameof(minElementIndex) + " is outside of the array!");
    ...
    {
        Debug.Assert(x != null, nameof(x) + " is null.");
        Debug.Assert(y != null, nameof(y) + " is null.");
    ...
    public static int BinarySearch<T>(T[] arr, T value) where T : IComparable<T>
    {
        ...
        Debug.Assert(index < arr.Length, "Returned index is larger than the length of the array!");
