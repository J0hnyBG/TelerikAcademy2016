...
intellisense.annotate(jQuery, {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored PlayerPiece of data.</summary>
    ///   <param name="element" type="Element">A DOM element from which to remove data.</param>
    ///   <param name="name" type="String">A string naming the PlayerPiece of data to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'data': function() {
    ...
    ///   <param name="key" type="String">A string naming the PlayerPiece of data to set.</param>
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored PlayerPiece of data.</summary>
    ///   <param name="name" type="String">A string naming the PlayerPiece of data to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored PlayerPiece of data.</summary>
