...
{
    public class RaceTrack : Identifiable, IRaceTrack
    {
        ...
        public void RunRace()
        {
            ...
            {
                // TODO: STIMPL
                Console.WriteLine(string.Format("Performing drag race on track \"{0}\" with {1} participants.", this.TrackName, participantsCount));
